...
class BaserowService {
  ...
  static Future<Map<String, dynamic>> createPin(Map<String, dynamic> data) async {
    ...
    final baserowData = {
      ...
      'field_7444': data['plan_image_name'] ?? '', // Plan image name (to identify which plan_image the pin belongs to)
    };
  ...
  static Future<void> updatePin(int baserowId, Map<String, dynamic> data) async {
    ...
    if (data.containsKey('plan_image_name')) baserowData['field_7444'] = data['plan_image_name'] ?? '';
  ...
  /// Upload multiple files in PARALLEL and return comma-separated URLs
